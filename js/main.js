...
(function () {
  ...
  const I18N = {
    es: {
      ...
      "contact.copy": "No importa si es un videojuego, una herramienta o simplemente una idea que llevas tiempo imaginando. En Cat Studio™ nos gusta construir cosas que hacen la vida un poco más divertida y un poco más fácil. Cuéntanos qué tienes en mente!",
      "contact.email_label": "Escríbenos directo a:",
      "contact.form_note": "Formulario de contacto gestionado con forms.app.",
      "contact.form_cta": "🐱 Crear formulario",
      "contact.email_cta": "📩 Escríbenos directamente",
    ...
    en: {
      ...
      "contact.title": "Do you have an idea?",
      "contact.copy": "It doesn’t matter if it’s a video game, a tool, or simply an idea you’ve been imagining for a while. At Cat Studio™, we love building things that make life a little more fun and a little easier. Tell us what you have in mind!.",
      "contact.email_label": "Write to us directly to:",
      "contact.form_note": "Contact form managed with forms.app.",
      "contact.form_cta": "🐱 Create form",
      "contact.email_cta": "📩 Write to us directly",
