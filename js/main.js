...
(function () {
  ...
  const I18N = {
    es: {
      ...
      "hero.eyebrow": "Estudio independiente · Cojutepeque, El Salvador",
    ...
    en: {
      ...
      "hero.eyebrow": "Independent studio · Cojutepeque, El Salvador",
  ...
  function initEasterEgg() {
    ...
    btn.addEventListener("click", () => {
      ...
      for (let i = 0; i < total; i++) {
        ...
        const duration = 2.1 + Math.random() * 1.1;
        const spin = (Math.random() > 0.5 ? 1 : -1) * (10 + Math.random() * 24);
